        ...
        <section>
            ...
            <article class="grille_mobile lg:grille_profil">
                ...
                <div class="col-span-4 row-start-2 flex flex-col">
                    <label class="font-text font-medium text-Secondary1(Gold) text-[24px] pb-3" for="img">URL de l'image de profil</label>
                    <input
                        ...
                        type="file" id="img" @change="handleFileUpload" />
                    <p></p>
                </div>
                ...
                <div class="col-span-4 row-start-4 flex flex-col">
                    ...
                    <input
                        class="bg-Primary1(Black) py-2 border border-Secondary2(Beige) font-text text-Secondary1(Gold) placeholder:text-Gray1 text-[16px] rounded-[8px] px-4"
                        type="text" id="name" placeholder="krys_film" v-model="newUsername"/>
                    <p></p>
                </div>

                <div class="col-span-4 row-start-5 flex flex-col">
                    <label class="font-text font-medium text-Secondary1(Gold) text-[24px] pb-3" for="passwd">Mot de
                        passe</label>
                    <input
                ...
                <div class="col-span-4 row-start-6 flex flex-col">
                    <label class="font-text font-medium text-Secondary1(Gold) text-[24px] pb-3" for="confirmPasswd">Répétez
                ...
                <button
                    class="col-span-2 col-start-2 row-start-7 py-4 mt-5 bg-Secondary1(Gold) font-text font-medium text-Primary1(Black) text-[20px] rounded-[8px]"
                    @click="updateProfile">
                    Sauvegarder
                </button>
