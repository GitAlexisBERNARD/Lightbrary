<script setup lang="ts">
    ...
    import SVG_blanc_1 from '@/components/icons/SVG_blanc_1.vue'
</script>
...
<template>
    <main>
        <section>
            <header>
                <div class="grille_mobile lg:grille_landing relative grid h-screen grid-rows-[10fr_1fr] pt-5">
                    <div class="col-span-4 lg:col-span-6 self-center font-text">
                        ...
                        <button class="hidden lg:block col-span-2 col-start-2 mt-10 lg:col-start-1 font-text font-medium text-Primary1(Black) bg-Secondary1(Gold) py-3 px-5 rounded-[8px]">
                            <RouterLink 
                                to=""
                            >
                                En savoir plus
                    ...
                    <button class="lg:hidden col-span-2 col-start-2 mt-10 lg:col-start-1 font-text font-medium text-Primary1(Black) bg-Secondary1(Gold) py-3 px-5 rounded-[8px] mb-20">
                        <RouterLink 
                            to=""
                        >
                            En savoir plus
                    ...
                    <div class="grille_mobile lg:grille_desktop mt-10">
                        ...
                        <div class="col-span-2 col-start-3 flex flex-col justify-between lg:col-start-5">
                            <button class="lg:col-start-1 font-text font-bold text-Primary1(Black) bg-Primary2(White) py-3 px-5 rounded-[8px] uppercase">
                                <RouterLink to="/pageitem" class="flex justify-between">
                                    Films
                                    <chevronRightVue/>
                                </RouterLink>
                            </button>
