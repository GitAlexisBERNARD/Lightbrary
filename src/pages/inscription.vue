...
<template>
  <main class="lg:grille_connexion bg-Primary1(Black)">
    ...
    <div class="col-span-4 col-start-5 row-start-3 flex flex-col">
    ...
    <div class="col-span-4 col-start-5 row-start-4 flex flex-col">
